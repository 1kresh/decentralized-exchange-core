...
interface ISimswapERC20Errors {
    error SimswapERC20_APPROVE_FROM_ZERO_ADDRESS(
        address owner,
        address spender,
        uint256 amount
    );
    error SimswapERC20_APPROVE_TO_ZERO_ADDRESS(
        address owner,
        address spender,
        uint256 amount
    );
    ...
    error SimswapERC20_TRANSFER_FROM_ZERO_ADDRESS(
        address spender,
        address recipient,
        uint256 amount
    );
    error SimswapERC20_TRANSFER_TO_ZERO_ADDRESS(
        address spender,
        address recipient,
        uint256 amount
    );
